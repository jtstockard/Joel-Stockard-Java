...
public class MathController {
        ...
        public MathSolution createAddNumber(@RequestBody MathSolution mathSolution) {
        ...
        @ResponseStatus(value = HttpStatus.CREATED)
        public MathSolution createSubtractNumber(@RequestBody MathSolution mathSolution) {
        ...
        @ResponseStatus(value = HttpStatus.CREATED)
        public MathSolution createMultiplyNumber(@RequestBody MathSolution mathSolution) {
        ...
        @ResponseStatus(value = HttpStatus.CREATED)
        public MathSolution createDivideNumber(@RequestBody MathSolution mathSolution) {
